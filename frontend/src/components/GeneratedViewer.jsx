...
function Mesa({ size = 120 }) {
  return (
    <>
      <Grid args={[size, size]} cellSize={10} cellThickness={0.6} cellColor="#3e3e42" sectionSize={50} sectionThickness={1.1} sectionColor="#007acc" fadeDistance={400} fadeStrength={1} />
    ...
    <div className="viewer-wrap h-full min-h-[420px]">
      ...
      {empty && (
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          ...
          <p className="text-vstext font-semibold m-0">Envie uma imagem para gerar o modelo</p>
          <p className="text-vsdim text-[13px] m-0">PNG, JPG ou WEBP · logo com fundo transparente funciona melhor</p>
        </div>
      )}
    </div>
  );
